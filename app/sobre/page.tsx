  ...
  [background-size:100%_4px]"
        ...
        <section className="mb-8">
          <p className="text-gray-700 leading-relaxed text-lg">
            O <strong>MEIdeSaquá</strong> é a vitrine digital dos
            Microempreendedores Individuais de Saquarema. Mais do que um site de
            produtos e serviços, é um espaço de valorização do talento local, da
            criatividade e da dedicação de quem empreende na nossa cidade.
          </p>
          ...
          <p className="text-gray-700 leading-relaxed text-lg mt-4">
            ...
            oportunidades de crescimento. O MEIdeSaquá é parte desse
            compromisso: um projeto que une inovação digital, identidade
            cultural e o fortalecimento dos negócios locais.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed text-lg">
            A plataforma MEIdeSaquá tem como objetivo principal fortalecer e
            fomentar o empreendedorismo local, valorizando os
            microempreendedores de Saquarema. Neste caso, para você estar apto a
            ter a divulgação na plataforma você deverá atualizar o seu cadastro
            do MEI para o município de Saquarema, em caso de dúvidas procure a
            Sala do Empreendedor para atualizar seu cadastro.
          </p>
        </section>
