...
export default function NovaSenha() {
  ...
  const handlePasswordReset = async (e: React.FormEvent) => {
    ...
    try {
      ...
      addNotification("Email enviado com sucesso! Verifique sua caixa de entrada.", "success");
      ...
      addNotification("Erro ao processar o pedido. Verifique os dados e tente novamente.", "error");
      console.error(err);
    }
  };
