...
export default function Cadastro() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    const userData = {
      ...
      username: username,
      email: email,
      senha: password, // A API espera 'senha', não 'password'
    };
    ...
    try {
      ...
      addNotification("Cadastro realizado com sucesso! Você será redirecionado.", "success");
      ...
      addNotification("Erro ao cadastrar. Verifique seus dados e tente novamente.", "error");
      console.error(err);
    }
  };
